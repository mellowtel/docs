...
title: "Mellowtel Support Modal for Extensions and Websites"
description: "Mellowtel Support Modal setup explains how to create a non-intrusive support prompt with custom copy, snooze behavior, storage fallback, and API use."
icon: "window-maximize"
robots: "index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"
canonical: "https://mellowtel.com/docs/mellowtel-elements/modal"
og:title: "Mellowtel Support Modal for Extensions and Websites"
og:description: "Mellowtel Support Modal setup explains how to create a non-intrusive support prompt with custom copy, snooze behavior, storage fallback, and API use."
og:url: "https://mellowtel.com/docs/mellowtel-elements/modal"
twitter:card: "summary"
twitter:title: "Mellowtel Support Modal for Extensions and Websites"
twitter:description: "Mellowtel Support Modal setup explains how to create a non-intrusive support prompt with custom copy, snooze behavior, storage fallback, and API use."
---
