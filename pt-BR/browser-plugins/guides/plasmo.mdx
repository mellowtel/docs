...
canonical: "https://mellowtel.com/docs/pt-BR/browser-plugins/guides/plasmo"
og:title: "Guia de Integração da Extensão de Navegador Mellowtel Plasmo"
og:description: "A integração Mellowtel Plasmo abrange configuração de pacotes, permissões, variáveis de ambiente, scripts de fundo e de conteúdo, configurações de popup e testes."
og:url: "https://mellowtel.com/docs/pt-BR/browser-plugins/guides/plasmo"
twitter:card: "summary"
twitter:title: "Guia de Integração da Extensão de Navegador Mellowtel Plasmo"
twitter:description: "A integração Mellowtel Plasmo abrange configuração de pacotes, permissões, variáveis de ambiente, scripts de fundo e de conteúdo, configurações de popup e testes."
---

Aqui você aprenderá como monetizar sua extensão de navegador Plasmo integrando Mellowtel.
Tempo estimado para conclusão: 5-15 minutos.

# Instalação Manual

Se você já tem um projeto Plasmo, siga estes passos para adicionar a integração Mellowtel.
...
3. Confira se a página de configurações é acessível
