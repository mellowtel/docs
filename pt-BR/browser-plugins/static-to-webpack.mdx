---
sidebarTitle: "De Estático para Webpack"
title: "Configurando o Webpack para um plugin de navegador"
icon: "cube"
robots: "index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"
canonical: "https://mellowtel.com/docs/pt-BR/browser-plugins/static-to-webpack"
og:title: "Configuração do Webpack para Extensões de Navegador e Mellowtel"
og:description: "A configuração do Webpack para extensões de navegador cobre estrutura de projeto, dependências npm, pontos de entrada, cópia de ativos, scripts de pacote, builds e testes locais."
og:url: "https://mellowtel.com/docs/pt-BR/browser-plugins/static-to-webpack"
twitter:card: "summary"
twitter:title: "Configuração do Webpack para Extensões de Navegador e Mellowtel"
twitter:description: "A configuração do Webpack para extensões de navegador cobre estrutura de projeto, dependências npm, pontos de entrada, cópia de ativos, scripts de pacote, builds e testes locais."
---
...
Comece estruturando seu projeto para acomodar arquivos de origem, ativos estáticos e a eventual saída empacotada. Seu diretório de projeto deve se parecer com isto:
...
Certifique-se de que o Node.js e o NPM estão instalados no seu sistema. O Node.js é essencial para executar o ecossistema de pacotes, e o NPM é usado para gerenciar as dependências do seu projeto.

### Passo 3: Instalando Webpack e Outras Dependências
...
Crie um arquivo `webpack.config.js` na raiz do seu projeto. Este arquivo deve definir seus pontos de entrada, configuração de saída, regras de módulo para carregar diferentes tipos de arquivos e plugins para funcionalidades adicionais. Veja como seu `webpack.config.js` deve se parecer com a configuração dada:
...
Certifique-se de que seu `manifest.json` e quaisquer arquivos HTML referenciem os scripts e ativos corretamente. Por exemplo, os scripts serão enviados para a pasta `dist`, então atualize os caminhos de acordo.
...
Para desenvolvimento, você pode fazer o Webpack observar seus arquivos e recompilar sempre que alterações forem detectadas:
