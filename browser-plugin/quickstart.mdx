...
For example you can put it in a handleSettings() function like this:

```javascript
async function handleSettings(details) {
    console.log("let users manage settings");
    try {
...
Perfect! Now you are ready to send your extension to the Web Store. Follow the guide here to see how to [submit your extension](https://docs.mellowtel.it/get-started/submit-to-Web-Store)
