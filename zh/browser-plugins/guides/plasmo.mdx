...
description: "快速指南，教你如何在 Plasmo 浏览器扩展中集成 Mellowtel"
icon: "puzzle"
robots: "index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"
canonical: "https://mellowtel.com/docs/zh/browser-plugins/guides/plasmo"
og:title: "Mellowtel Plasmo 浏览器扩展集成指南"
og:description: "Mellowtel Plasmo 集成涵盖包设置、权限、环境变量、后台和内容脚本、弹出设置和测试。"
og:url: "https://mellowtel.com/docs/zh/browser-plugins/guides/plasmo"
twitter:card: "summary"
twitter:title: "Mellowtel Plasmo 浏览器扩展集成指南"
twitter:description: "Mellowtel Plasmo 集成涵盖包设置、权限、环境变量、后台和内容脚本、弹出设置和测试。"
---
