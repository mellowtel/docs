...
canonical: "https://mellowtel.com/docs/zh/desktop-app/windows"
og:title: "Mellowtel Windows .NET 桌面应用集成指南"
og:description: "Mellowtel Windows .NET 集成涵盖 NuGet 安装、Integration ID 设置、用户同意处理、选择加入设置、示例和故障排除步骤。"
og:url: "https://mellowtel.com/docs/zh/desktop-app/windows"
twitter:card: "summary"
twitter:title: "Mellowtel Windows .NET 桌面应用集成指南"
twitter:description: "Mellowtel Windows .NET 集成涵盖 NuGet 安装、Integration ID 设置、用户同意处理、选择加入设置、示例和故障排除步骤。"
---
