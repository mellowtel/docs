...
canonical: "https://mellowtel.com/docs/nl/browser-plugins/optional-integrations/meucci"
og:title: "Mellowtel Meucci Module Setup voor Browser Plugins Gids"
og:description: "Mellowtel Meucci module setup legt uit hoe je het pakket installeert, standaard en Plasmo builds, manifest resources en initContentScript configuratie."
og:url: "https://mellowtel.com/docs/nl/browser-plugins/optional-integrations/meucci"
twitter:card: "summary"
twitter:title: "Mellowtel Meucci Module Setup voor Browser Plugins Gids"
twitter:description: "Mellowtel Meucci module setup legt uit hoe je het pakket installeert, standaard en Plasmo builds, manifest resources en initContentScript configuratie."
---
...
Hieronder vind je instructies voor het inschakelen van de Meucci-functie in je browserplugin, met opties voor zowel standaard- als Plasmo-frameworkimplementaties.
...
Maak een `build-meucci.js` bestand in je projectroot met de volgende inhoud:
...
const waitForDirectory = async (dir, timeout = 10000) => {
  ...
  while (!fs.existsSync(dir)) {
    if (Date.now() - start > timeout) {
      throw new Error(`Timeout bij wachten op map: ${dir}`)
    }
    await new Promise(resolve => setTimeout(resolve, 100))
  }
}

// Maak de build functie
