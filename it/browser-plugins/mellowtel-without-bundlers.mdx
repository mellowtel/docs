...
title: "Integrare Mellowtel senza Bundler"
icon: "box"
robots: "index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"
canonical: "https://mellowtel.com/docs/it/browser-plugins/mellowtel-without-bundlers"
og:title: "Guida a Mellowtel Senza Bundler per Estensioni Browser"
og:description: "Mellowtel senza bundler mostra come utilizzare un file pre-bundled o generarne uno con esbuild, configurare il manifest e testare la configurazione della tua estensione."
og:url: "https://mellowtel.com/docs/it/browser-plugins/mellowtel-without-bundlers"
twitter:card: "summary"
twitter:title: "Guida a Mellowtel Senza Bundler per Estensioni Browser"
twitter:description: "Mellowtel senza bundler mostra come utilizzare un file pre-bundled o generarne uno con esbuild, configurare il manifest e testare la configurazione della tua estensione."
---

Questa guida spiega come integrare Mellowtel nella tua estensione per browser senza utilizzare bundler come Webpack o Vite. Invece, utilizzerai un singolo file pre-bundled che funziona sia negli script di contenuto che nei service worker.
...
├── content_script.js
├── manifest.json
└── mellowtel.js           # Sarà aggiunto nel prossimo passaggio
```
...
#### Bundle di Mellowtel con esbuild
...
- Raggruppa tutte le dipendenze in un singolo file
- Utilizza il formato IIFE con un nome globale per la compatibilità universale
- Aggiunge un footer per rendere l'export di default disponibile globalmente
...
Indipendentemente dall'opzione scelta sopra, configura il tuo `manifest.json` per includere il bundle di Mellowtel negli script di contenuto:
...
**Importante**: 
- Il campo `"type": "module"` abilita le importazioni di moduli ES nel tuo service worker.
...
Per gli script di contenuto, Mellowtel è disponibile come variabile globale (non è necessario importare, poiché è caricato tramite il manifest):
