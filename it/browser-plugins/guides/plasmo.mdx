...
canonical: "https://mellowtel.com/docs/it/browser-plugins/guides/plasmo"
og:title: "Guida all’integrazione dell’estensione del browser Mellowtel Plasmo"
og:description: "L’integrazione di Mellowtel Plasmo copre la configurazione del pacchetto, i permessi, le variabili d’ambiente, gli script di background e di contenuto, le impostazioni del popup e i test."
og:url: "https://mellowtel.com/docs/it/browser-plugins/guides/plasmo"
twitter:card: "summary"
twitter:title: "Guida all’integrazione dell’estensione del browser Mellowtel Plasmo"
twitter:description: "L’integrazione di Mellowtel Plasmo copre la configurazione del pacchetto, i permessi, le variabili d’ambiente, gli script di background e di contenuto, le impostazioni del popup e i test."
---
...
Se hai un progetto Plasmo esistente, segui questi passaggi per aggiungere l'integrazione di Mellowtel.
...
<Warning>
    Assicurati di sostituire `your_mellowtel_api_key_here` con la tua effettiva chiave API Mellowtel dal dashboard.
</Warning>
