...
canonical: "https://mellowtel.com/docs/it/browser-plugins/optional-integrations/pascoli"
og:title: "Guida al Modulo Pascoli di Mellowtel per Plugin del Browser"
og:description: "La configurazione del modulo Pascoli di Mellowtel copre l’installazione del pacchetto, file HTML e JavaScript, build standard e Plasmo, risorse del manifesto e initContentScript."
og:url: "https://mellowtel.com/docs/it/browser-plugins/optional-integrations/pascoli"
twitter:card: "summary"
twitter:title: "Guida al Modulo Pascoli di Mellowtel per Plugin del Browser"
twitter:description: "La configurazione del modulo Pascoli di Mellowtel copre l’installazione del pacchetto, file HTML e JavaScript, build standard e Plasmo, risorse del manifesto e initContentScript."
---
...
Di seguito sono riportate le istruzioni per abilitare la funzionalità Pascoli nel tuo plugin del browser, con opzioni per implementazioni sia standard che con il framework Plasmo.
...
`pascoli.html` dovrebbe essere incluso automaticamente nella tua directory di build se hai seguito la configurazione iniziale [webpack config setup](/browser-plugins/static-to-webpack) e l'hai aggiunto alla directory `public`.
