...
canonical: "https://mellowtel.com/docs/it/browser-plugins/optional-integrations/meucci"
og:title: "Guida alla Configurazione del Modulo Meucci di Mellowtel per Plugin del Browser"
og:description: "La configurazione del modulo Meucci di Mellowtel spiega l’installazione del pacchetto, le build standard e Plasmo, le risorse del manifest e la configurazione di initContentScript."
og:url: "https://mellowtel.com/docs/it/browser-plugins/optional-integrations/meucci"
twitter:card: "summary"
twitter:title: "Guida alla Configurazione del Modulo Meucci di Mellowtel per Plugin del Browser"
twitter:description: "La configurazione del modulo Meucci di Mellowtel spiega l’installazione del pacchetto, le build standard e Plasmo, le risorse del manifest e la configurazione di initContentScript."
---
...
Nella directory src, o ovunque tu abbia file js, crea un file chiamato `meucci.js` e aggiungi il seguente codice. Assicurati che questo file venga incluso nella tua directory di build finale (/dist).

Se hai seguito la configurazione iniziale [webpack config setup](/browser-plugins/static-to-webpack), puoi semplicemente aggiungere questo file all'oggetto `entry` nel tuo webpack config.
...
### 2. Aggiorna il tuo webpack config
...
Nella directory src, o ovunque tu abbia file ts, crea un file chiamato `meucci.ts` e aggiungi il seguente codice:
...
async function buildMeucci() {
  ...
  // Copia nelle directory dev e prod
  const directories = [ 
  ...
  ] // TODO: SOSTITUISCI con i percorsi alle tue directory dev e prod

  // Elabora tutte le directory contemporaneamente
...
Questo assicurerà che il file Meucci sia correttamente bundle e copiato in tutte le directory di build nella corretta struttura Plasmo.
...
Se hai anche abilitato Pascoli, puoi usare il seguente:
