...
og:description: "La guida alla privacy di Mellowtel spiega le richieste sandboxed e senza credenziali e elenca quali dati l’SDK non può accedere prima che gli utenti condividano la larghezza di banda in sicurezza."
...
twitter:description: "La guida alla privacy di Mellowtel spiega le richieste sandboxed e senza credenziali e elenca quali dati l’SDK non può accedere prima che gli utenti condividano la larghezza di banda in sicurezza."
---
...
La logica di sandboxing è open source. Se tu o il tuo team di sicurezza volete verificare il modello di isolamento prima della distribuzione, leggete il codice sorgente su [GitHub](https://github.com/mellowtel-inc/).
