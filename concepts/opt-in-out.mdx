---
title: "Mellowtel Opt-In and Opt-Out User Consent API Guide"
description: "Mellowtel opt in and opt out guidance covers consent requirements, hosted settings links, custom UI methods, and update announcements for users later."
icon: "signature"
robots: "index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"
canonical: "https://mellowtel.com/docs/concepts/opt-in-out"
og:title: "Mellowtel Opt-In and Opt-Out User Consent API Guide"
og:description: "Mellowtel opt in and opt out guidance covers consent requirements, hosted settings links, custom UI methods, and update announcements for users later."
og:url: "https://mellowtel.com/docs/concepts/opt-in-out"
twitter:card: "summary"
twitter:title: "Mellowtel Opt-In and Opt-Out User Consent API Guide"
twitter:description: "Mellowtel opt in and opt out guidance covers consent requirements, hosted settings links, custom UI methods, and update announcements for users later."
---
