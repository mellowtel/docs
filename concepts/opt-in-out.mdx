...
## 2) Custom elements
You can create your own opt-in/opt-out elements. If users agree you can activate them on the Network by calling the `optIn()` method. If they don't agree, you call the `optOut()` method.
