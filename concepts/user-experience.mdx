...
## Explanation
When you build a Chrome Extension, you want to make sure that it doesn't negatively affect the user experience.
Extension should always add value to the user, and not take away from it. One core principle is making them as unobtrusive as possible.
...
It uses an array of optimizations under the hood (such as making the request in an iframe that gets immediately removed) to ensure that it doesn't slow down the user's browsing experience.
