...
description: "Plasmoブラウザ拡張機能にMellowtelを統合するためのクイックガイド"
icon: "puzzle"
robots: "index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"
canonical: "https://mellowtel.com/docs/ja/browser-plugins/guides/plasmo"
og:title: "Mellowtel Plasmoブラウザ拡張機能統合ガイド"
og:description: "Mellowtel Plasmoの統合では、パッケージ設定、権限、環境変数、バックグラウンドおよびコンテンツスクリプト、ポップアップ設定、テストをカバーします。"
og:url: "https://mellowtel.com/docs/ja/browser-plugins/guides/plasmo"
twitter:card: "summary"
twitter:title: "Mellowtel Plasmoブラウザ拡張機能統合ガイド"
twitter:description: "Mellowtel Plasmoの統合では、パッケージ設定、権限、環境変数、バックグラウンドおよびコンテンツスクリプト、ポップアップ設定、テストをカバーします。"
---
