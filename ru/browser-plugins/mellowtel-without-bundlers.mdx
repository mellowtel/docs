...
canonical: "https://mellowtel.com/docs/ru/browser-plugins/mellowtel-without-bundlers"
og:title: "Mellowtel без сборщиков для руководства по расширениям браузера"
og:description: "Mellowtel без сборщиков показывает, как использовать предварительно собранный файл или сгенерировать его с помощью esbuild, настроить манифест и протестировать настройку вашего расширения."
og:url: "https://mellowtel.com/docs/ru/browser-plugins/mellowtel-without-bundlers"
twitter:card: "summary"
twitter:title: "Mellowtel без сборщиков для руководства по расширениям браузера"
twitter:description: "Mellowtel без сборщиков показывает, как использовать предварительно собранный файл или сгенерировать его с помощью esbuild, настроить манифест и протестировать настройку вашего расширения."
---
...
### Вариант 2: Сгенерировать собственный пакет

Если вы предпочитаете сгенерировать пакет самостоятельно, выполните следующие шаги:
...
- Создает `mellowtel.js` в директории для сборки
...
## Настройка вашего манифеста (оба варианта)
...
## Использование Mellowtel в вашем расширении
...
Для контент-скриптов Mellowtel доступен как глобальная переменная (импорт не требуется, так как он загружается через манифест):
...
Этот подход дает вам преимущества использования Mellowtel без сложности настройки полной системы сборки, такой как Webpack или Vite.