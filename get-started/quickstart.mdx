...
<Warning>Option 2 hasn't been tested and it could still disable your extension. We recommend using [extension-update-testing-tool](https://github.com/GoogleChromeLabs/extension-update-testing-tool) to test before sending an update</Warning>
