...
canonical: "https://mellowtel.com/docs/es/browser-plugins/optional-integrations/meucci"
og:title: "Guía de Configuración del Módulo Meucci de Mellowtel para Plugins de Navegador"
og:description: "La configuración del módulo Meucci de Mellowtel explica la instalación del paquete, las compilaciones estándar y Plasmo, los recursos del manifiesto y la configuración de initContentScript."
og:url: "https://mellowtel.com/docs/es/browser-plugins/optional-integrations/meucci"
twitter:card: "summary"
twitter:title: "Guía de Configuración del Módulo Meucci de Mellowtel para Plugins de Navegador"
twitter:description: "La configuración del módulo Meucci de Mellowtel explica la instalación del paquete, las compilaciones estándar y Plasmo, los recursos del manifiesto y la configuración de initContentScript."
---

<Warning>
    Esta función requiere la versión 1.6.2 o superior de Mellowtel. Este es un cambio importante en comparación con versiones anteriores.
</Warning>
...
A continuación se presentan las instrucciones para habilitar la función Meucci en tu plugin de navegador, con opciones tanto para implementaciones estándar como para el framework Plasmo.

## Implementación Estándar

### 1. Crea un archivo JavaScript llamado `meucci.js`

En el directorio src, o donde tengas tus archivos js, crea un archivo llamado `meucci.js` y añade el siguiente código. Asegúrate de que este archivo se incluya en tu directorio de compilación final (/dist).
...
## Implementación del Framework Plasmo

Si estás usando el framework Plasmo, sigue estos pasos alternativos:

### 1. Crea un archivo TypeScript llamado `meucci.ts`

En el directorio src, o donde tengas tus archivos ts, crea un archivo llamado `meucci.ts` y añade el siguiente código:
...
// Función para esperar a que un directorio exista
...
Para el framework Plasmo, puedes usar lo siguiente:

```typescript
// Para el framework Plasmo
await initContentScript({
    meucciFilePath: "meucci.js"
});
```
...
```typescript
await initContentScript({
    pascoliFilePath: "pascoli.html", // o "tabs/pascoli.html" si usas el framework Plasmo
    meucciFilePath: "meucci.js"
});
```