...
canonical: "https://mellowtel.com/docs/es/browser-plugins/optional-integrations/pascoli"
og:title: "Guía del Módulo Pascoli de Mellowtel para Plugins de Navegador"
og:description: "La configuración del módulo Pascoli de Mellowtel cubre la instalación del paquete, archivos HTML y JavaScript, compilaciones estándar y Plasmo, recursos del manifiesto e initContentScript."
og:url: "https://mellowtel.com/docs/es/browser-plugins/optional-integrations/pascoli"
twitter:card: "summary"
twitter:title: "Guía del Módulo Pascoli de Mellowtel para Plugins de Navegador"
twitter:description: "La configuración del módulo Pascoli de Mellowtel cubre la instalación del paquete, archivos HTML y JavaScript, compilaciones estándar y Plasmo, recursos del manifiesto e initContentScript."
---
...
Mellowtel proporciona una función opcional que te permite manejar más solicitudes y, por lo tanto, ganar más. Esta función se llama "Pascoli".
...
A continuación se presentan las instrucciones para habilitar la función Pascoli en tu plugin de navegador, con opciones para implementaciones tanto estándar como del marco Plasmo.
...
Crea un archivo llamado `pascoli.tsx` en tu directorio `tabs`. Si no tienes un directorio `tabs`, crea uno. Más información sobre `tabs` en el marco Plasmo se puede encontrar [aquí](https://docs.plasmo.com/framework/tab-pages). Añade el siguiente código al archivo `pascoli.tsx`:
