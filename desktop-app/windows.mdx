...
title: "Mellowtel Windows .NET Desktop App Integration Guide"
description: "Mellowtel Windows .NET integration covers NuGet install, Integration ID setup, consent handling, opt-in settings, examples, and troubleshooting steps."
icon: "windows"
platforms:
  - desktop app
robots: "index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"
canonical: "https://mellowtel.com/docs/desktop-app/windows"
og:title: "Mellowtel Windows .NET Desktop App Integration Guide"
og:description: "Mellowtel Windows .NET integration covers NuGet install, Integration ID setup, consent handling, opt-in settings, examples, and troubleshooting steps."
og:url: "https://mellowtel.com/docs/desktop-app/windows"
twitter:card: "summary"
twitter:title: "Mellowtel Windows .NET Desktop App Integration Guide"
twitter:description: "Mellowtel Windows .NET integration covers NuGet install, Integration ID setup, consent handling, opt-in settings, examples, and troubleshooting steps."
---
