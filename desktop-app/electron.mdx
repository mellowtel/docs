...
title: "Mellowtel Electron SDK Integration and Consent Guide"
description: "Mellowtel Electron SDK setup covers npm registry auth, installation, consent dialogs, settings, request counters, lifecycle behavior, and troubleshooting."
icon: "bolt"
platforms:
  - desktop app
...
og:description: "Mellowtel Electron SDK setup covers npm registry auth, installation, consent dialogs, settings, request counters, lifecycle behavior, and troubleshooting."
...
twitter:description: "Mellowtel Electron SDK setup covers npm registry auth, installation, consent dialogs, settings, request counters, lifecycle behavior, and troubleshooting."
---
