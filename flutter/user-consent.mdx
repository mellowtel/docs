---
title: "Mellowtel Flutter User Consent and Settings Setup Guide"
description: "Mellowtel Flutter user consent setup covers dialog configuration, start behavior, consent settings pages, manual opt-in methods, and status checks."
icon: "toggle-on"
robots: "index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"
canonical: "https://mellowtel.com/docs/flutter/user-consent"
og:title: "Mellowtel Flutter User Consent and Settings Setup Guide"
og:description: "Mellowtel Flutter user consent setup covers dialog configuration, start behavior, consent settings pages, manual opt-in methods, and status checks."
og:url: "https://mellowtel.com/docs/flutter/user-consent"
twitter:card: "summary"
twitter:title: "Mellowtel Flutter User Consent and Settings Setup Guide"
twitter:description: "Mellowtel Flutter user consent setup covers dialog configuration, start behavior, consent settings pages, manual opt-in methods, and status checks."
---
