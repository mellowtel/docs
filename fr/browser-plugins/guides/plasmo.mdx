...
canonical: "https://mellowtel.com/docs/fr/browser-plugins/guides/plasmo"
og:title: "Guide d’intégration de l’extension de navigateur Mellowtel Plasmo"
og:description: "L’intégration Mellowtel Plasmo couvre la configuration du package, les permissions, les variables d’environnement, les scripts d’arrière-plan et de contenu, les paramètres de popup, et les tests."
og:url: "https://mellowtel.com/docs/fr/browser-plugins/guides/plasmo"
twitter:card: "summary"
twitter:title: "Guide d’intégration de l’extension de navigateur Mellowtel Plasmo"
twitter:description: "L’intégration Mellowtel Plasmo couvre la configuration du package, les permissions, les variables d’environnement, les scripts d’arrière-plan et de contenu, les paramètres de popup, et les tests."
---

Ici, tu apprendras à monétiser ton extension de navigateur Plasmo en intégrant Mellowtel.
