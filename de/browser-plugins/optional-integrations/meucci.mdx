...
canonical: "https://mellowtel.com/docs/de/browser-plugins/optional-integrations/meucci"
og:title: "Mellowtel Meucci Modul Einrichtung für Browser-Plugins Anleitung"
og:description: "Die Einrichtung des Mellowtel Meucci Moduls erklärt die Paketinstallation, Standard- und Plasmo-Builds, Manifest-Ressourcen und die initContentScript-Konfiguration."
og:url: "https://mellowtel.com/docs/de/browser-plugins/optional-integrations/meucci"
twitter:card: "summary"
twitter:title: "Mellowtel Meucci Modul Einrichtung für Browser-Plugins Anleitung"
twitter:description: "Die Einrichtung des Mellowtel Meucci Moduls erklärt die Paketinstallation, Standard- und Plasmo-Builds, Manifest-Ressourcen und die initContentScript-Konfiguration."
---
...
Mellowtel bietet eine optionale Funktion, die es dir ermöglicht, mehr Anfragen zu bearbeiten und somit mehr zu verdienen. Diese Funktion heißt "Meucci".
...
Wenn du die anfängliche [webpack-Konfigurationseinrichtung](/browser-plugins/static-to-webpack) befolgt hast, kannst du diese Datei einfach dem `entry`-Objekt in deiner webpack-Konfiguration hinzufügen.
...
Füge die `meucci.js`-Datei deinem `manifest.json` als web_accessible_resources hinzu:
...
Wenn du das Plasmo-Framework verwendest, befolge diese alternativen Schritte:
...
Erstelle eine `build-meucci.js`-Datei in deinem Projektstammverzeichnis mit folgendem Inhalt:
...
2. Oder es zu deinem bestehenden Build-Skript mit `&` hinzufügen: `"build": "your-existing-build-command & npm run build:meucci"`
...
Für beide Implementierungen, ändere deine `initContentScript`-Methode im Content-Skript, um den korrekten Pfad zur Meucci-Datei einzuschließen:

```typescript
// Für Standard-Implementierung
