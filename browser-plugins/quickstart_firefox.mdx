...
title: "Mellowtel Firefox Extension Integration With Lite SDK"
description: "Mellowtel Firefox extension setup explains the mellowtel-lite package, Manifest V2 and V3 permissions, background scripts, content scripts, and settings."
icon: "firefox"
robots: "index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"
canonical: "https://mellowtel.com/docs/browser-plugins/quickstart_firefox"
og:title: "Mellowtel Firefox Extension Integration With Lite SDK"
og:description: "Mellowtel Firefox extension setup explains the mellowtel-lite package, Manifest V2 and V3 permissions, background scripts, content scripts, and settings."
og:url: "https://mellowtel.com/docs/browser-plugins/quickstart_firefox"
twitter:card: "summary"
twitter:title: "Mellowtel Firefox Extension Integration With Lite SDK"
twitter:description: "Mellowtel Firefox extension setup explains the mellowtel-lite package, Manifest V2 and V3 permissions, background scripts, content scripts, and settings."
---
...
First, install the Mellowtel Lite (`mellowtel-lite`) npm package. Please note that for Firefox you can only import the `mellowtel-lite` package to stay compliant with the browser's policies regarding ancillary user data:
