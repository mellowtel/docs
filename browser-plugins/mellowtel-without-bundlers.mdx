...
title: "Mellowtel Without Bundlers for Browser Extensions Guide"
description: "Mellowtel without bundlers shows how to use a pre-bundled file or generate one with esbuild, configure the manifest, and test your extension setup."
icon: "box"
robots: "index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"
canonical: "https://mellowtel.com/docs/browser-plugins/mellowtel-without-bundlers"
og:title: "Mellowtel Without Bundlers for Browser Extensions Guide"
og:description: "Mellowtel without bundlers shows how to use a pre-bundled file or generate one with esbuild, configure the manifest, and test your extension setup."
og:url: "https://mellowtel.com/docs/browser-plugins/mellowtel-without-bundlers"
twitter:card: "summary"
twitter:title: "Mellowtel Without Bundlers for Browser Extensions Guide"
twitter:description: "Mellowtel without bundlers shows how to use a pre-bundled file or generate one with esbuild, configure the manifest, and test your extension setup."
---
