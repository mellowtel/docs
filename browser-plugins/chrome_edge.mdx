...
title: "Mellowtel Chrome and Edge Extension Integration Guide"
description: "Mellowtel Chrome and Edge extension setup covers policies, Manifest V3 permissions, service workers, content scripts, opt-in flow, and settings links."
icon: "chrome"
robots: "index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"
canonical: "https://mellowtel.com/docs/browser-plugins/chrome_edge"
og:title: "Mellowtel Chrome and Edge Extension Integration Guide"
og:description: "Mellowtel Chrome and Edge extension setup covers policies, Manifest V3 permissions, service workers, content scripts, opt-in flow, and settings links."
og:url: "https://mellowtel.com/docs/browser-plugins/chrome_edge"
twitter:card: "summary"
twitter:title: "Mellowtel Chrome and Edge Extension Integration Guide"
twitter:description: "Mellowtel Chrome and Edge extension setup covers policies, Manifest V3 permissions, service workers, content scripts, opt-in flow, and settings links."
---
...
<Info>
If choosing to create your own opt-in/opt-out elements, consider using <a href="/mellowtel-elements/quickstart" target="_blank">**Mellowtel Elements**</a> - pre-built UI components that handle user consent and settings with minimal integration effort.
</Info>
