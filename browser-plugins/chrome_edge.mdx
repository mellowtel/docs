...
<Info>
If choosing to create your own opt-in/opt-out elements, consider using <a href="/docs/mellowtel-elements/quickstart" target="_blank">**Mellowtel Elements**</a> - pre-built UI components that handle user consent and settings with minimal integration effort.
</Info>
