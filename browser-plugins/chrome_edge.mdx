...
<Info>
**Looking for a faster setup?** Consider using [**Mellowtel Elements**](/mellowtel-elements/quickstart) - pre-built UI components that handle user consent and settings with minimal integration effort.
</Info>
